...
export type GetLessonsBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, title: string, videoId: string, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };

export type GetLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', lessonType: LessonType, slug: string, title: string, availableAt?: any | null, id: string }> };
